...
package cn.joylau.scripts.engine.common;
...
import cn.joylau.scripts.engine.ScriptListener;
...
public abstract class CommonScriptEngine extends ListenerSupportEngine {
    ...
    @Override
    public cn.joylau.scripts.engine.ScriptContext  getContext(String id) {
    ...
    protected class CommonScriptContext extends cn.joylau.scripts.engine.ScriptContext  {
